...
export const TurkLiraIcon = ({ className = '', size = 24, color = 'currentColor', ...props }) => {
  return (
    <svg 
      width={size} 
      height={size} 
      viewBox="0 0 69.803 69.804" 
      fill={color} 
      className={className}
    ...
    >
      <path 
        d="M58.338,28.84c-0.54-2.225-2.316-2.463-3.056-2.463c-1.232,0-2.448,0.568-3.17,1.486c-0.634,0.805-0.827,1.816-0.558,2.922
