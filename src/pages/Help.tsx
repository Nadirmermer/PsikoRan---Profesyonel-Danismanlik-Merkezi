...
export function Help() {
  ...
  return (
    <LegalLayout
      ...
      description="Sıkça sorulan sorular ve yardım dökümanları"
    >
      {/* Hero Bölümü */}
      <div className="bg-gradient-to-r from-primary-500 to-primary-600 dark:from-primary-600 dark:to-primary-700 -mx-8 -mt-8 px-8 py-12 mb-12 rounded-lg">
